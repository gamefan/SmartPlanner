...
void main() {
  ...
  group('HomeViewModel', () {
    ...
    test('submitMemo adds note and clears input', () async {
      ...
      await viewModel.submitMemo(type: MemoType.note, timeRangeType: TimeRangeType.none, content: '這是一筆備註');
    ...
    test('submitMemo adds todo with correct type', () async {
      ...
      await viewModel.submitMemo(type: MemoType.todo, timeRangeType: TimeRangeType.evening, content: '晚上去慢跑');
